      ...
      <section>
        <div className="mb-5 flex items-center justify-between gap-4">
          <h2 className="text-xl font-semibold text-slate-950">
            Explore {categoryData.name.en} Prompts
          </h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {subcategories.map((subcategory) => (
            <Link
              key={subcategory.id}
              href={`/${locale}/prompts/${categoryData.id}/${subcategory.id}`}
            ...
            >
              ...
              <span className="mt-auto pt-5 inline-flex items-center text-sm font-semibold text-blue-600 transition-colors group-hover:text-blue-700">
                View prompts
                <span
                  aria-hidden="true"
